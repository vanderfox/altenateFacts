 ...
 * "Hero.ComicSpeechletRequestStreamHandler" For this to work, you'll also need to build
 * this project using the {@code lambda-compile} Ant task and upload the resulting zip file to power
 * your function.
 */
public final class ComicSpeechletRequestStreamHandler extends SpeechletRequestStreamHandler {
    private  static final Logger log = LoggerFactory.getLogger(ComicSpeechletRequestStreamHandler.class)
    ...
    public ComicSpeechletRequestStreamHandler() {
        super(new com.vanderfox.comic.ComicSpeechlet(), supportedApplicationIds);
    }
