 ...
 * "Hero.AlternateFactsSpeechletRequestStreamHandler" For this to work, you'll also need to build
 * this project using the {@code lambda-compile} Ant task and upload the resulting zip file to power
 * your function.
 */
public final class AlternateFactsSpeechletRequestStreamHandler extends SpeechletRequestStreamHandler {
    private  static final Logger log = LoggerFactory.getLogger(AlternateFactsSpeechletRequestStreamHandler.class)
    ...
    public AlternateFactsSpeechletRequestStreamHandler() {
        super(new AlternateFactsSpeechlet(), supportedApplicationIds);
    }
